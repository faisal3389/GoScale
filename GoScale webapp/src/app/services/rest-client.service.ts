...
export class RestClient {
    ...
    constructor( @Inject(Http) private http: Http, private router: Router) {
        ...
        this.baseRequestOptions.headers.set('Content-Type', 'application/json');
        // this.baseRequestOptions.headers.append('Access-Control-Allow-Origin', '*');
        // this.baseRequestOptions.headers.append('Access-Control-Allow-Credentials', '*');
    }
